...
namespace UHFDemo
{
    partial class CYMessageBox : Form
    {
        ...
        static private void BuildMessageBox(string title)
        {
            ...
            newMessageBox.BackColor = System.Drawing.Color.DarkGray;
        ...
        static void newMessageBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            */
            //wb modify
            int boundry = 3;
            Rectangle centerArea = new Rectangle(0, 0, newMessageBox.Width, newMessageBox.Height);
            SolidBrush areaGB = new SolidBrush(Color.FromArgb(64,64,64));
            g.FillRectangle(areaGB, centerArea);
